...
namespace AppMVC.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Surname,Age,Id,CreatedAt,UpdatedAt")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Surname,Age,Id,CreatedAt,UpdatedAt")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
